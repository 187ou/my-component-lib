...
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...
    ...{ class: ([
            `my-notification--${__VLS_ctx.type}`,
            `my-notification--${__VLS_ctx.position}`
        ]) },
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "my-notification__content" },
});
if (__VLS_ctx.title) {
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
    ...{ class: "my-notification__message" },
});
if (__VLS_ctx.isVNode) {
    const __VLS_12 = ((__VLS_ctx.message));
    // @ts-ignore
...
var __VLS_3;
/** @type {__VLS_StyleScopedClasses['my-notification']} */ ;
/** @type {__VLS_StyleScopedClasses['my-notification__icon']} */ ;
/** @type {__VLS_StyleScopedClasses['my-notification__content']} */ ;
/** @type {__VLS_StyleScopedClasses['my-notification__title']} */ ;
/** @type {__VLS_StyleScopedClasses['my-notification__message']} */ ;
/** @type {__VLS_StyleScopedClasses['my-notification__close']} */ ;
var __VLS_dollars;
